...
public class LoginRadiusSDK {
	...
	private static String API_ROOT = "https://api.loginradius.io";
	...
	public static boolean validate() {
		return Initialize.apiKey == null || Initialize.apiKey.length() == 0 ? false : true;
	}

	@SuppressWarnings("serial")
	public static class InitializeException extends RuntimeException {
		public InitializeException() {
			super("LoginRadius Java SDK not initialized properly");
		}
	}
